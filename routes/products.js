...
// Routes for products
// CREATE
router.post('/products', ProductController.createProduct); // Route to create a new product
...
// UPDATE
router.put('/products/:id', ProductController.updateProduct); // Route to update a product by its ID

// DELETE
router.delete('/products/:id', ProductController.deleteProduct); // Route to delete a product by its ID
