...
// Routes for products
// CREATE
router.post('/products', authMiddleware, ProductController.createProduct); // Route to create a new product
...
// UPDATE
router.put('/products/:id', authMiddleware, ProductController.updateProduct); // Route to update a product by its ID

// DELETE
router.delete('/products/:id', authMiddleware, ProductController.deleteProduct); // Route to delete a product by its ID
